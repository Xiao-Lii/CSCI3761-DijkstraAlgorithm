...
*   Student ID  :   109284250
*   Class       :   CSCI 3761 - Computer Networks
*   HW #        :   Networking - PA#1
...
NOTE*: 	The max size of the characters to be read/written to & from a file is 1000 characters. 
...
SIDE NOTE #2: The program will work out of this order, but this is the quickest way to checking/ensuring 
...
SIDE NOTE #3: The temp.txt file for the server program must be placed in the main folder with main.cpp 
